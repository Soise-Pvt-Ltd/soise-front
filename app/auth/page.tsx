  ...
  return (
    <>
      <div className="mx-auto px-[16px] pt-[100px] md:max-w-xl">
        <h1 className="!font-display pb-[34px] text-center text-[54px] tracking-[0.2em] uppercase">
          Sosie
        </h1>
        <div className="auth">
          <div>
            ...
            <div>
              ...
              />
              <button className="btn_outline !my-[36px]">Continue</button>
            </div>
          </div>
          ...
          <div>
            ...
            />
            <button className="btn_black !my-[36px]">Continue</button>
          </div>

          <div>
            <div className="gap-y-[16px] pb-[40px]">
              <div className="text-[18px]">Enter code</div>
              <div className="text-[14px] text-[#8E8E93]">Sent to {email}</div>
            </div>
            <input
              type="number"
              className="form-input grey"
