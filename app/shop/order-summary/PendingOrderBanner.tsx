...
export function PendingOrderBanner({
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full shrink-0 overflow-hidden rounded-[2px] border-2 border-[#121212] md:w-[360px]">
        <button
          type="button"
          onClick={onCancel}
          disabled={resuming || cancelling}
          className="w-1/4 cursor-pointer border-r-2 border-[#121212] bg-white px-[8px] py-[13px] text-[11px] font-bold tracking-wide text-[#121212] uppercase transition-colors duration-200 hover:bg-[#121212]/5 disabled:cursor-not-allowed disabled:opacity-50"
        >
          {cancelling ? '…' : 'Cancel'}
        </button>
        <button
